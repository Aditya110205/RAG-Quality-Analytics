...
The project combines **RAG engineering with data engineering** to create an end-to-end platform capable of collecting, processing, transforming, validating, and analyzing RAG system telemetry.

The architecture is intentionally developed locally first, allowing the data engineering pipeline to be validated before introducing cloud infrastructure.
...
Quality Evaluation
    =
RAG Quality Analytics Platform
```
